    ...
    public class Skill
    {
        ...
        private void UpdateSkill()
        {
            ...
            else if(this.Define.HitTimes != null && this.Define.HitTimes.Count > 0)
            {
                ...
                {
                    //Debug.LogFormat("Update SkillTime is {0}", skillTime);
        ...
        private void CastBullet()
        {
            ...
            Log.InfoFormat("Skill[{0}].CastBullet[{1}] Target:{2}", this.Define.Name, this.Define.BulletResource, this.Target.Name);
