...
public class SoundManager : MonoSingleton<SoundManager> {
	...
	public void PlayMusic(string name)
	{
		...
		float volume;
        this.audioMixer.GetFloat("MusicVolume", out volume);
        if(volume != this.MusicVolume)
            this.SetVolume("MusicVolume", this.MusicVolume);
    ...
    public void PlaySound(string name)
    {
        ...
        float volume;
        this.audioMixer.GetFloat("SoundVolume", out volume);
        if (volume != this.SoundVolume)
            this.SetVolume("SoundVolume", this.SoundVolume);
