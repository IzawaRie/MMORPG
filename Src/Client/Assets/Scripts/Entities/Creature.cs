...
namespace Entities
{
    public class Creature: Entity
    {
        ...
        public void DoDamage(NDamageInfo damage, bool playHurt)
        {
            ...
            if(this.Controller != null)
            {
                UIWorldElementManager.Instance.ShowPopupText(PopupType.Damage, this.Controller.GetTransform().position + this.GetGroupOffest(), -damage.Damage, damage.Crit);
            }
        }
