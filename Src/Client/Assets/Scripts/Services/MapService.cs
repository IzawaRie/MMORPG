...
namespace Services
{
    class MapService : Singleton<MapService>, IDisposable
    {
        ...
        public void SendMapEntitySync(EntityEvent entityEvent,NEntity entity,int param)
        {
            ...
            Debug.LogFormat("MapEnityUpdateRequest:EntityID{0} POS:{1} DIR:{2} SPD{3}", entity.Id, entity.Position.String(), entity.Direction.String(), entity.Speed);
        ...
        {
            Debug.LogFormat("MapTeleportRequst :teleporterID:{0}", teleporterID);
            NetMessage message= new NetMessage();
            message.Request = new NetMessageRequest(); 
