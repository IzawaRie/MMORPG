...
public class EntityController : MonoBehaviour,IEntityNotify,IEntityController
{
    ...
    {
        this.entity = entity;
        Debug.LogErrorFormat("OnEntityChanged :ID:{0} POS:{1} DIR:{2} SPD:{3} ", entity.entityId, GameObjectTool.LogicToWorld(entity.position), GameObjectTool.LogicToWorld(entity.direction), entity.speed);
    }
