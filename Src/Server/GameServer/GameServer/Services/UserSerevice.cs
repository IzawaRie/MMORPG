    ...
    class UserService : Singleton<UserService>
    {
        ...
        private void OnCreateCharacter(NetConnection<NetSession> sender, UserCreateCharacterRequest request)
        {
            ...
            TCharacter character = new TCharacter()
            {
                ...
                MapPosZ = 820,
                Gold = 100000,
                HP = (int)DataManager.Instance.Characters[(int)request.Class].MaxHP + (int)DataManager.Instance.Characters[(int)request.Class].STR * 10,
                MP = (int)DataManager.Instance.Characters[(int)request.Class].MaxMP + (int)DataManager.Instance.Characters[(int)request.Class].INT * 10,
                Equips = new byte[20],
                Player = new TPlayer()          
            };
