...
namespace GameServer.Entities
{
    class Character : Creature,IPostResponser
    {
        ...
        public int Ride
        {
            ...
            set { if (this.Info.Ride == value) return;this.Info.Ride = value; }
        }
        public void PostProcess(NetMessageResponse message)
        {
            ...
            if(this.Guild != null)
            {
                Log.InfoFormat("PostProcess > Guild:chracterID:{0}:{1} {2}<{3}",this.Id,this.Info.Name,GuildUpdateTS, this.Guild.timestamp);
